...
This code:
- loads stan model that has no (very small sigma) stan_no_sigvar.stan
...
mod = cmdstanpy.CmdStanModel(stan_file="C:\\Users\\pe1n24\\Desktop\\STAN\\stan_no_sigvar.stan")
# %%
#SET UP DATA 
...
#this will generate a predicted y value for each data point 8000 times. 
...
#%% save
sumstats.to_csv(f"output/no_var_sig_SUMSTATS.csv", index = False)
df.to_csv(f"output/no_var_sig_ALLDATA.csv", index = False)
